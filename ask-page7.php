...
<head>
    ...
    <title>HS | Question 7</title>
</head>
<body>
    <?php include './Ressources/header.php' ?>
    <form action="ask-page8.php" method="post" onsubmit=" return validateNumber();"> 
    <h1 class="h1-content">Personal Health Survey</h1>
         ...
         <div class="content-1">
            ...
            <div>
                <input class="input-number" type="number" id="input-number" name="res7"
                  min="1" max="10" onchange="numberChanged();" autofocus>
            </div>
    
    
            <input type="hidden" name="lastPageID" value="ask-page7">
