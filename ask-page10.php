...
<head>
    ...
    <title>HS | Question 10</title>
</head>
<body>
 
     <?php include './Ressources/header.php' ?>
  
      <form action="result.php" method="post" onsubmit= " return validateNumber();">
          ...
          <div class="content-1">
            <div>
                <p>An einem typischen Tag: Wie viele deiner
                    Malzeiten kommen<br> aus der Mikrowelle
                    oder sind schon fertig zubereitet?</p>
            </div>
            <div>
                <input class="input-number" type="number" id="input-number" name="res10"
                  min="1" max="10" onchange="numberChanged();" autofocus>
            </div>
    
            <input type="hidden" name="lastPageID" value="ask-page10">
